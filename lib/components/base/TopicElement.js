...
var MarkerSpan = styled.span(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  top: -4px;\n  background: #ff0000b5;\n  left: ", "px;\n  height: 3px;\n  width: ", "px;\n  position: absolute;\n"], ["\n  top: -4px;\n  background: #ff0000b5;\n  left: ", "px;\n  height: 3px;\n  width: ", "px;\n  position: absolute;\n"])), function (_a) {
...
var TopicElement = (function (_super) {
    ...
    TopicElement.prototype.render = function () {
        var _a = this.props, height = _a.height, color = _a.color, text = _a.text, width = _a.width, markers = _a.markers, onClick = _a.onClick;
        return (React.createElement(ElementContainer, { width: width, height: height, color: color, isInteractive: !!onClick, onClick: onClick },
            ...
            markers &&
                markers.map(function (marker) { return (React.createElement(MarkerSpan, { position: marker.position, width: marker.width })); })));
    };
