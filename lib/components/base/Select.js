...
var Select = function (_a) {
    ...
    return (React.createElement(StyledSelectContainer, null,
        labelComponent,
        React.createElement(StyledSelect, { value: initialValue, onChange: onChange }, values.map(function (option) { return (React.createElement("option", { value: option.id, key: option.id }, option.text)); }))));
};
