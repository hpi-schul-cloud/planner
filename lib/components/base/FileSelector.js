    ...
    FileSelector.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", null, files.map(function (file) { return (React.createElement("div", null,
                React.createElement(StyledFileName, { key: file.id, onClick: function () { return _this.props.onFileClick(file); } }, file.name),
                React.createElement(StyledRemove, { key: file.id, onClick: function () { return _this.props.onFileRemove(file); } }, "Remove"))); })),
