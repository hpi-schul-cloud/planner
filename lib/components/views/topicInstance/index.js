    ...
    TopicInstanceView.prototype.render = function () {
        ...
        return (React.createElement(StyledContainer, null,
            ...
            React.createElement(FormElementDiv, null,
                ...
                React.createElement(ComponentProvider.SelectorInput, { typeOptions: [{ text: 'Mündlich', value: 'spoken' }], timeOptions: [{ text: '1.Woche', value: '1W' }], values: this.state.currentValues.examinations, onChange: function (value) { return _this.onFormChange(value, 'examinations'); } })),
            React.createElement(FormElementDiv, null,
                React.createElement(FlexContainer, null,
