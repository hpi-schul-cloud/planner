...
var RasterUnitContainer_1 = __importDefault(require("./RasterUnitContainer"));
var componentProvider_1 = __importDefault(require("../../provider/componentProvider"));
var timeHelper_1 = require("../calendar/timeHelper");
var ExpansionPanelContainer = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  margin: 25px 0px;\n"], ["\n  margin: 25px 0px;\n"])));
var RasterUnitDiv = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  min-width: 0px;\n"], ["\n  min-width: 0px;\n"])));
var FlexContainer = styled_components_1.default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: baseline;\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: baseline;\n"])));
...
var ClassConfigurationView = (function (_super) {
    ...
    function ClassConfigurationView(props) {
        ...
        _this.generateRasterUnits = function (instancesAndTemplates) {
            ...
            var rasterCount = timeHelper_1.getWeekDifference(new Date(selectedSchoolYear.utcStartDate), new Date(selectedSchoolYear.utcEndDate));
            var relevantEventData = _this.props.eventData.filter(function (event) {
                return (event.utcStartDate >= selectedSchoolYear.utcStartDate &&
            ...
            return classLevelArray.length > 0 ? (classLevelArray.map(function (classLevel) { return (react_1.default.createElement(ExpansionPanelContainer, { key: classLevel.classLevelId },
                react_1.default.createElement(componentProvider_1.default.ExpansionPanel, { key: selectedSchoolYearId + "-" + selectedSubjectId + "-" + classLevel.classLevelName, caption: classLevel.classLevelName },
                    react_1.default.createElement(RasterUnitDiv, null,
                        react_1.default.createElement(RasterUnitContainer_1.default, { rasterCount: rasterCount, rasterSize: RASTER_SIZE, topicTemplates: templates[classLevel.classLevelId], classLevelId: classLevel.classLevelId, classInstances: classLevel.classes, schoolYear: selectedSchoolYear, eventData: relevantEventData, onAddTemplateClick: function (classLevelId) {
                                return _this.props.onAddTemplate(selectedSubjectId, classLevelId);
                            }, onEditTemplate: _this.props.onEditTemplate, onDeleteTemplate: _this.props.onDeleteTemplate, onEditInstance: _this.props.onEditInstance, onUpdate: _this.updateLocalClassTopicsForYear }))))); })) : (react_1.default.createElement("div", null, "No classes assigned!"));
        };
        _this.onSelectChange = function (id) {
            _this.setState({
    ...
    ClassConfigurationView.prototype.render = function () {
        ...
        return (react_1.default.createElement(StyledContainer, null,
            react_1.default.createElement(FlexContainer, null,
                react_1.default.createElement(componentProvider_1.default.Select, { initialValue: this.state.selectedSchoolYearId, onChange: function (event) {
                        return _this.onSelectChange(event.target.value);
                    }, values: selectOptions, caption: 'Schuljahr:' }),
                react_1.default.createElement(componentProvider_1.default.Button, { caption: "Speichern", color: "primary", disabled: this.props.allClassTopics === this.state.localAllClassTopics, onClick: this.onSaveButtonClick })),
            react_1.default.createElement(componentProvider_1.default.Tabs, { items: this.getRadioItems(), onChange: this.onRadioButtonChange, selected: this.state.selectedSubjectId }),
            rasterUnits));
    };
    return ClassConfigurationView;
}(react_1.Component));
exports.default = ClassConfigurationView;
