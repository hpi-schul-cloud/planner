...
var RasterUnitContainer = (function (_super) {
    ...
    function RasterUnitContainer(props) {
        ...
        _this.handleDeleteTopicTemplate = function (templateId) {
            _this.props.onDeleteTemplate(_this.props.classLevelId, templateId);
        };
        _this.state = {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(FlexContainer, null,
                ...
                React.createElement(FlexChild, null,
                    React.createElement(InteractiveRasterUnit, { updateClassInstances: this.updateClassInstance, classInstances: this.props.classInstances, topicTemplates: this.props.topicTemplates, rasterCount: this.props.rasterCount, rasterSize: this.props.rasterSize, wrapRasterRows: this.wrapRasterRowsWithGrid, classLevelId: this.props.classLevelId, onEditTemplate: this.props.onEditTemplate, onDeleteTemplate: this.handleDeleteTopicTemplate, onEditInstance: this.props.onEditInstance, onSaveConfiguration: this.props.onSaveConfiguration }),
