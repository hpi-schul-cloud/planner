...
exports.getEmptySpaceSize = function (rasterCount, topicElements) {
...
exports.getClassTopicsAfterInsertion = function (insertStartIndex, width, elementValues, rasterCount, currentClassInstances) {
    ...
    if (actualNextElementIndex !== null) {
        ...
        result.push(__assign({ id: uniqueId_1.default('el_'), color: '', text: '' }, elementValues, { startIndex: actualInsertionPosition, endIndex: actualInsertionPosition + width - 1 }));
...
exports.getClassTopicsAfterMove = function (insertStartIndex, elementIndex, width, elementValues, rasterCount, currentClassInstances) {
    var result;
    ...
    if (insertStartIndex < movingElement.startIndex ||
        ...
        result = exports.getClassTopicsAfterInsertion(insertStartIndex + width >= rasterCount
            ? rasterCount - width
