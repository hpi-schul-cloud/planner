    ...
    function InteractiveRasterRow() {
        ...
        _this.generateElements = function () {
            ...
            var _loop_1 = function () {
                ...
                elements.push(React.createElement(TopicTooltip, { key: id, isDisabled: _this.props.isOver, isLocal: !!isLocal, onEditClick: function () { return _this.props.onEditInstance(id); }, onDeleteClick: function () { return _this.props.onDeleteInstance(rowId, index); }, onSaveConfiguration: _this.props.onSaveConfiguration },
