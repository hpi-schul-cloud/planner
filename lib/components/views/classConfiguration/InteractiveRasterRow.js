        ...
        insertStartIndex =
            insertStartIndex < 0
                ...
                : insertStartIndex >= props.rasterCount
                    ? props.rasterCount - 1
                    : insertStartIndex;
        var _a = monitor.getItem(), type = _a.type, width = _a.width, id = _a.id, text = _a.text, color = _a.color, isLocal = _a.isLocal, parentTemplateId = _a.parentTemplateId;
        if (type === TOPIC_INSTANCE) {
        ...
        _this.generateElements = function () {
            ...
            var _loop_1 = function () {
                ...
                if (topicElements[i].startIndex > nextIndex) {
                    elements.push(React.createElement(FillerElement, { width: (startIndex - nextIndex) * rasterSize, key: "Filler-" + i }));
                }
            ...
            if (nextIndex < rasterCount) {
                elements.push(React.createElement(FillerElement, { width: (rasterCount - nextIndex) * rasterSize, key: "Filler-" + i }));
            }
            return elements;
        };
        return _this;
