...
var determineEndIndex = function (_a) {
    ...
    if (dayIsGreaterThan(topicEndDate, rowEndDate)) {
        ...
        var initialEndIndex = getDayDifference(rowStartDate, topicEndDate);
...
export var determineIndices = function (_a) {
    ...
    var rowDayCount = getDayCount(rowStartDate.getTime(), rowEndDate.getTime());
...
export var getEventMaps = function (holidayEvents, otherEvents, rowPeriod) {
    var columnColorMap = {};
    var eventTypeMap = {};
    var eventIndexMap = {};
    var utcStartDate = new Date(rowPeriod.utcStartDate);
    var deltaDays = getDayCount(rowPeriod.utcStartDate, rowPeriod.utcEndDate);
    var setupMapsForEvents = function (events, columnColorMap, eventTypeMap, type) {
        events.forEach(function (event) {
            ...
            var endIndex = getDayDifference(utcStartDate, new Date(event.utcEndDate));
