...
export function filterRelevantElementData(utcStartDate, utcEndDate, elements) {
...
export var getWeekPeriodForDate = function (date, numberOfWeeks) {
...
export var getFilteredClassTopicsData = function (classTopics, _a) {
