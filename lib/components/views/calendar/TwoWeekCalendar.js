...
var DayClassRows_1 = __importDefault(require("./DayClassRows"));
...
var TwoWeekCalendar = (function (_super) {
    ...
    TwoWeekCalendar.prototype.render = function () {
        ...
        var twoWeekTimePeriod = calendarHelper_1.getWeekPeriodForDate(utcToday, 2);
        ...
        var filteredHolidaysData = calendarHelper_1.filterRelevantElementData(twoWeekTimePeriod.utcStartDate, twoWeekTimePeriod.utcEndDate, holidaysData);
        var filteredOtherEventsData = calendarHelper_1.filterRelevantElementData(twoWeekTimePeriod.utcStartDate, twoWeekTimePeriod.utcEndDate, otherEventsData);
        var filteredClassTopicsData = calendarHelper_1.getFilteredClassTopicsData(classTopicsData, twoWeekTimePeriod);
        return (react_1.default.createElement(StyledFlexContainer, null,
            ...
            react_1.default.createElement(DayClassRows_1.default, { rasterSize: rasterSize, rowPeriod: twoWeekTimePeriod, utcToday: utcToday, classTopicsData: filteredClassTopicsData, holidaysData: filteredHolidaysData, otherEventsData: filteredOtherEventsData, onTopicInstanceClick: onTopicInstanceClick })));
    };
...
exports.default = TwoWeekCalendar;
