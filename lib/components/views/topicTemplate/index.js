...
var TopicTemplateView = (function (_super) {
    ...
    function TopicTemplateView(props) {
        ...
        if (_this.props.initialValues)
            _this.state = {
                currentValues: __assign({}, _this.state.currentValues, _this.props.initialValues)
            };
        return _this;
    }
    TopicTemplateView.prototype.render = function () {
        ...
        return (React.createElement(StyledContainer, null,
            ...
            React.createElement(FormElementDiv, null,
                ...
                React.createElement(ComponentProvider.FileSelector, { files: this.state.currentValues.material, onFileClick: this.props.onFileClick, onFileAdd: this.props.onFileAdd, onFileRemove: this.props.onFileRemove, onFormChange: function () { } })),
