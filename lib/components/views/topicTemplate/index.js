        ...
        return (React.createElement(StyledContainer, null,
            React.createElement(FormElementDiv, null,
                React.createElement(InlineTextFieldDiv, null,
                    React.createElement(ComponentProvider.Select, { initialValue: "biology", values: [{ value: 'biology', text: 'Biologie' }], caption: "Fach", onChange: function (event) {
                            return _this.onFormChange(event.currentTarget.value, 'subject');
                        } })),
                React.createElement(InlineTextFieldDiv, null,
                    React.createElement(ComponentProvider.Select, { initialValue: "8", values: [{ value: '8', text: '8' }], caption: "Jahrgang", onChange: function (event) {
