...
var RasterTopicElement = (function (_super) {
    ...
    RasterTopicElement.prototype.render = function () {
        ...
        var height = sizeMap[size];
        return (react_1.default.createElement(componentProvider_1.default.TopicElement, __assign({ width: width, height: height }, otherProps)));
    };
...
exports.default = RasterTopicElement;
